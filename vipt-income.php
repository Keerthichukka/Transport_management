     ...
     while($row=$result->fetch_assoc())
{
    ...
    <td> <a href='pdf.php?BUS_NUMBER=$row[BUS_NUMBER]'><button id='bottone1' style='height:50px; padding:5px; font-size:12px;'><strong>$row[BUS_NUMBER]</strong></button></a></td>
    ...
    <td>$row[PROFIT]</td>
    <td>
    <a class='btn btn-primary btn-sm' href='/Transport-project/edit-expenses2.php?BUS_NUMBER=$row[BUS_NUMBER]'>Edit</a>
