            ...
            if ($_SERVER['REQUEST_METHOD']=='GET')
{
    ...
    echo "<a href='school-pdf1.php?BUS_NUMBER=$row[bus_number]'><button id='bottone1' style='height:50px; padding:5px; float:right;font-size:12px;'><strong>search</strong></button></a><br>";
