...
if ($_SERVER['REQUEST_METHOD']=='GET')
{
    ...
    $sql=("SELECT * FROM school WHERE BUS_NUMBER='$BUS_NUMBER'");
...
$col5=$_POST["col5"];
    ...
    die($mysqli->error);   
           ...
           $sql=("INSERT INTO school_pdf(date, RE, CM, PM, ES, TAX,amount,bus_number,col1,col2,col3,col4,col5) VALUES ('$DATE','$RECURRING_EXPENDIATURE','$CORRECTIVE_MAINTAINANCE','$PREVENTIVE_MAINTAINANCE','$EMPLOYEES_SALARY','$TAXES','$amount','$BUS_NUMBER','$col1','$col2','$col3','$col4','$col5')");
        $result=$connection->query($sql);
        if (!$result)
        {
            $errorMessage="Invalid query: ".$connection->error;
...
<div class="col-sm-3 d-grid">
    <a class="btn btn-outline-primary" href="/transport-project/student-income.php" role="button">Cancel</a>
</div>
</div>
</form>
</div>
