...
<div class="container my-5">
    ...
    <a class="btn btn-primary" href="/Transport-project/vipt-create.php" role="button">New bus</a>
    <br>
...
<tbody>
    ...
    <td>$row[FEE]</td>
    <td>
    <a class='btn btn-primary btn-sm' href='/Transport-project/vipt-edit.php?BUS_NUMBER=$row[BUS_NUMBER]'>Edit</a>
    <a class='btn btn-danger btn-sm' href='/Transport-project/vipt-delete.php?BUS_NUMBER=$row[BUS_NUMBER]'>Delete</a>
    </td>
    </tr>
        ";
     }
