...
{      
       ...
       $STARTING_POINT=$_POST['STARTING_POINT'];
        ...
        do{
         ...
         $sql = "INSERT INTO vipt (BUS_NUMBER,BOARDING_TIME,BUS_DRIVER,CONTACT_NUMBER,STOPS,NO_OF_PASSENGERS,MILEAGE,PERMIT_DUE_DATE,INSURANCE_DUE_DATE,STARTING_POINT,FEE) VALUES ('$BUS_NUMBER','$BOARDING_TIME','$BUS_DRIVER','$CONTACT_NUMBER','$STOPS','$NO_OF_PASSENGERS','$MILEAGE','$PERMIT_DUE_DATE','$INSURANCE_DUE_DATE','$STARTING_POINT','$FEE')";
        $result=$connection->query($sql);
        if(!$result)
        {
