...
if ($_SERVER['REQUEST_METHOD']=='GET')
{
    ...
    $S_NO=$_GET["S_NO"];
    $sql="SELECT * FROM view WHERE S_NO=$S_NO";
    ...
    $BUS_NUMBER = $_POST['BUS_NUMBER'];
       ...
       $STARTING_POINT=$_POST['STARTING_POINT'];
        ...
        do{
            ...
            $S_NO=$_GET["S_NO"];
            $sql=("UPDATE view SET BUS_NUMBER='$BUS_NUMBER',BOARDING_TIME='$BOARDING_TIME',BUS_DRIVER='$BUS_DRIVER',CONTACT_NUMBER='$CONTACT_NUMBER',STOPS='$STOPS',NO_OF_PASSENGERS='$NO_OF_PASSENGERS',MILEAGE='$MILEAGE',PERMIT_DUE_DATE='$PERMIT_DUE_DATE',INSURANCE_DUE_DATE='$INSURANCE_DUE_DATE',STARTING_POINT='$STARTING_POINT',FEE='$FEE' WHERE S_NO=$S_NO")or
    die($mysqli->error);   
            $result=$connection->query($sql);
            if (!$result)
            {
