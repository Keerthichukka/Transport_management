...
<div class="container my-5">
    ...
    <a class="btn btn-primary" href="/Transport-project/create.php" role="button">New bus</a>
    <br>
    <table class="table" style="width:100%;  text-align: center;">
    <thread>
    <tr>
  
    <th style="width:50%">BUS NUMBER</th>
    <th>BOARDING TIME</th>
...
<tbody>
    ...
    <td>$row[FEE]</td>
    <td>
    <a class='btn btn-primary btn-sm' href='/Transport-project/edit.php?S_NO=$row[S_NO]'>Edit</a>
    <a class='btn btn-danger btn-sm' href='/Transport-project/delete.php?S_NO=$row[S_NO]'>Delete</a>
    </td>
    </tr>
        ";
     }
