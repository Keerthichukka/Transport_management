...
if ($_SERVER['REQUEST_METHOD']=='GET')
{
    ...
    # code...
        ...
        do{
            ...
            $sql=("UPDATE student SET fee='$fee' WHERE roll_number='$roll_number'")or
    die($mysqli->error);   
            $result=$connection->query($sql);
            if (!$result)
            {
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $sql2 = "SELECT fee AS total_fee FROM student WHERE bus_number = '$bus_id'";
...
<div class="col-sm-3 d-grid">
    <a class="btn btn-outline-primary" href="/transport-project/student.php" role="button">Cancel</a>
</div>
</div>
</form>
</div>
